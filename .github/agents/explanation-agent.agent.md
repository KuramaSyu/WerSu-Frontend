...
- Probably alsways when he just asks something (a questionmark is used).
...
- If user asked for explanation or learning help: provide a minimal example only. When giving an example, use a codeblock with enough comments, cut unrelevant parts and use the right MD language for syntax highlighting.
